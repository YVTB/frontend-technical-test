...
const PlayStore: React.FC<IPlayStoreProps> = ({
	width = 135,
	height = 40,
	small = false
}) => {
      ...
      height={small ? height : height * 2}
		...
		>
			...
			<path
				...
				transform='matrix(1.253 0 0 -1.2384 -9.796 49.85)'
			/>
			<g mask='url(#m)' transform='matrix(1.253 0 0 -1.2384 -9.796 49.85)'>
				<g clipPath='url(#n)'>
					<path d='M0 0h124v48H0V0z' fill='url(#o)' />
				</g>
			</g>
			<g mask='url(#p)' transform='matrix(1.253 0 0 -1.2384 -9.796 49.85)'>
				<g clipPath='url(#q)'>
					<path d='M0 0h124v48H0V0z' fill='url(#r)' />
				</g>
			</g>
			<g>
				<g mask='url(#s)' transform='matrix(1.253 0 0 -1.2384 -9.796 49.85)'>
					<g clipPath='url(#t)'>
			...
			<g>
				<g mask='url(#v)' transform='matrix(1.253 0 0 -1.2384 -9.796 49.85)'>
					<g clipPath='url(#w)'>
